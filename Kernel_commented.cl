...
//kernel_cubic is for computation of kernel function using O(n^2) algorithm
...
//kernel_derivative is for the computation of the vector derivative of the kernel
...
//All delta fuctions are used to stop race conditions
...
// Launch one kernel per FLUID particle
//Updates the density of the particles
